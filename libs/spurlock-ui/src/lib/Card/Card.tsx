...
export const Card = forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const variants = {
      ...
      elevated:
        'bg-[var(--color-surface-elevated)] shadow-[var(--shadow-md)] border border-[var(--color-border-soft)]',
    ...
    const dashedBorderStyle = dashedBorder
      ? 'border-[4px] border-dashed border-gray-300'
      : '';

    const classes = `${baseStyles} ${radius} ${variants[variant]} ${paddings[padding]} ${borderStyle} ${dashedBorderStyle} ${className}`;
